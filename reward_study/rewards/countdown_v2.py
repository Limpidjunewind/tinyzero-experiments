"""
Improved reward function for countdown task.
Multi-granularity scoring with process reward signals.

Changes vs original:
1. Continuous proximity score instead of binary 0.1/1.0
2. Process reward: think-answer consistency, self-verification
3. Operation complexity bonus (encourage *, /)
4. Partial number usage credit
"""
...
def compute_score(solution_str, ground_truth, method='strict', format_score=0.1, score=1.):
    ...
    if numbers_valid:
        ...
        if total > 0:
            total_score += 0.05 * (matched / total) * 0.5  # max 0.025 for partial
